...
The Bot was developed to increase ease of reporting and to help users identify scams. Now with the ScamShield Bot, users in Singapore can easily report scam messages and calls directly through WhatsApp. This decreases friction for reporting since more than 90% of Singaporeans are on WhatsApp. In addition, with scams increasingly migrating to 3rd party platforms like WhatsApp, the ScamShield Bot on WhatsApp makes it easy for users to simply forward scam messages received on WhatsApp, or from any other 3rd party platforms, and send them to the ScamShield Bot for reporting.

**Besides the Bot’s core reporting and checking features, here are additional features** we’ve developed to improve the user experience:
